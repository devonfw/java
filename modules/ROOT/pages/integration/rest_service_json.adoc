...
Data types such as Date and Time, Money etc requires special handling. Please find attached link:https://github.capgemini.com/CG-Europe-ABL/devonfw/tree/master/examples/service/mts-json[example].
--
