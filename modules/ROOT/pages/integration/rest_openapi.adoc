= Open Api Generator
// https://github.capgemini.com/CG-Europe-ABL/devonfw/issues/6
...
- link:https://github.capgemini.com/CG-Europe-ABL/devonfw/tree/master/examples/service/openapidemo[Example Project]
